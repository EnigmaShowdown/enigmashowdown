...
import com.enigmashowdown.game.conquest.collision.WaterUserData
...
class ConquestWater(
    ...
    private val body = world.createBody(
        ...
        body.createFixture(
            FixtureDef().apply {
                ...
                filter.categoryBits = CollisionCategory.WATER.mask
    ...
    override fun toState(): EntityState {
        return EntityState(id, position, EntityType.WATER)
    }
}
