...
import com.enigmashowdown.game.conquest.collision.FireUserData
...
class ConquestFire(
    ...
    private val body = world.createBody(
        ...
        body.createFixture(
            FixtureDef().apply {
                ...
                filter.categoryBits = CollisionCategory.FIRE.mask
    ...
    override fun toState(): EntityState {
        return EntityState(id, position, EntityType.FIRE)
    }
}
