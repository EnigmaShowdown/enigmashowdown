        ...
        if (levelStateBroadcast.ticksUntilBegin != 0) {
            ...
            client.send(
                PlayerActionRequest(
                    ...
                    } else if (state.tick < 34.0) {
                        ConquestAction(
                            moveAction = MoveAction(Math.toRadians(10.0), 10.0),
                        )
                    } else {
                        ConquestAction(
...
fun main(args: Array<String>) {
    ClientFramework("localhost", EnigmaShowdownConstants.PORT_SERVER, Level6AI).start()
}
